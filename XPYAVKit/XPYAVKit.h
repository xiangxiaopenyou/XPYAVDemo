...
//! Project version string for XPYAVKit.
FOUNDATION_EXPORT const unsigned char XPYAVKitVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <XPYAVKit/PublicHeader.h>
